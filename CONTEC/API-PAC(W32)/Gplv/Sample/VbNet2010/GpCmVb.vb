...
Module GPIBCMPT
	...
	Declare Function ibbna32 Lib "Gpib-32.dll" Alias "ibbnaA" (ByVal ud As Integer, ByRef sstr As String) As Integer
	...
	Declare Function ibcmd32 Lib "Gpib-32.dll" Alias "ibcmd" (ByVal ud As Integer, ByRef sstr As String, ByVal cnt As Integer) As Integer
	Declare Function ibcmda32 Lib "Gpib-32.dll" Alias "ibcmda" (ByVal ud As Integer, ByRef sstr As String, ByVal cnt As Integer) As Integer
	...
	Declare Function ibfind32 Lib "Gpib-32.dll" Alias "ibfindA" (ByRef sstr As String) As Integer
    ...
    Declare Function ibrda32 Lib "Gpib-32.dll" Alias "ibrda" (ByVal ud As Integer, ByRef sstr As String, ByVal cnt As Integer) As Integer
    Declare Function ibrdf32 Lib "Gpib-32.dll" Alias "ibrdfA" (ByVal ud As Integer, ByRef sstr As String) As Integer
    Declare Function ibrpp32 Lib "Gpib-32.dll" Alias "ibrpp" (ByVal ud As Integer, ByRef sstr As String) As Integer
    ...
    Declare Function ibwrta32 Lib "Gpib-32.dll" Alias "ibwrta" (ByVal ud As Integer, ByRef sstr As String, ByVal cnt As Integer) As Integer
    Declare Function ibwrtf32 Lib "Gpib-32.dll" Alias "ibwrtfA" (ByVal ud As Integer, ByRef sstr As String) As Integer
    Declare Sub AllSpoll32 Lib "Gpib-32.dll" Alias "AllSpoll" (ByVal ud As Integer, ByRef arg1 As Short, ByRef arg2 As Short)
    Declare Sub DevClear32 Lib "Gpib-32.dll" Alias "DevClear" (ByVal ud As Integer, ByVal v As Integer)
    Declare Sub DevClearList32 Lib "Gpib-32.dll" Alias "DevClearList" (ByVal ud As Integer, ByRef arg1 As Short)
    Declare Sub EnableLocal32 Lib "Gpib-32.dll" Alias "EnableLocal" (ByVal ud As Integer, ByRef arg1 As Short)
    Declare Sub EnableRemote32 Lib "Gpib-32.dll" Alias "EnableRemote" (ByVal ud As Integer, ByRef arg1 As Short)
    ...
    Declare Sub FindRQS32 Lib "Gpib-32.dll" Alias "FindRQS" (ByVal ud As Integer, ByRef arg1 As Short, ByRef result As Integer)
    ...
    Declare Sub PPollUnconfig32 Lib "Gpib-32.dll" Alias "PPollUnconfig" (ByVal ud As Integer, ByRef arg1 As Short)
    Declare Sub RcvRespMsg32 Lib "Gpib-32.dll" Alias "RcvRespMsg" (ByVal ud As Integer, ByRef arg1 As String, ByVal cnt As Integer, ByVal term As Integer)
    ...
    Declare Sub Receive32 Lib "Gpib-32.dll" Alias "Receive" (ByVal ud As Integer, ByVal addr As Integer, ByRef arg1 As String, ByVal cnt As Integer, ByVal term As Integer)
    Declare Sub ReceiveSetup32 Lib "Gpib-32.dll" Alias "ReceiveSetup" (ByVal ud As Integer, ByVal addr As Integer)
    Declare Sub ResetSys32 Lib "Gpib-32.dll" Alias "ResetSys" (ByVal ud As Integer, ByRef arg1 As Short)
    Declare Sub Send32 Lib "Gpib-32.dll" Alias "Send" (ByVal ud As Integer, ByVal addr As Integer, ByRef sstr As String, ByVal cnt As Integer, ByVal term As Integer)
    Declare Sub SendCmds32 Lib "Gpib-32.dll" Alias "SendCmds" (ByVal ud As Integer, ByRef sstr As String, ByVal cnt As Integer)
    Declare Sub SendDataBytes32 Lib "Gpib-32.dll" Alias "SendDataBytes" (ByVal ud As Integer, ByRef sstr As String, ByVal cnt As Integer, ByVal term As Integer)
    Declare Sub SendIFC32 Lib "Gpib-32.dll" Alias "SendIFC" (ByVal ud As Integer)
    Declare Sub SendList32 Lib "Gpib-32.dll" Alias "SendList" (ByVal ud As Integer, ByRef arg1 As Short, ByRef arg2 As String, ByVal cnt As Integer, ByVal term As Integer)
    Declare Sub SendLLO32 Lib "Gpib-32.dll" Alias "SendLLO" (ByVal ud As Integer)
    Declare Sub SendSetup32 Lib "Gpib-32.dll" Alias "SendSetup" (ByVal ud As Integer, ByRef arg1 As Short)
    Declare Sub SetRWLS32 Lib "Gpib-32.dll" Alias "SetRWLS" (ByVal ud As Integer, ByRef arg1 As Short)
    Declare Sub TestSys32 Lib "Gpib-32.dll" Alias "TestSys" (ByVal ud As Integer, ByRef arg1 As Short, ByRef arg2 As Short)
    Declare Sub Trigger32 Lib "Gpib-32.dll" Alias "Trigger" (ByVal ud As Integer, ByVal addr As Integer)
    Declare Sub TriggerList32 Lib "Gpib-32.dll" Alias "TriggerList" (ByVal ud As Integer, ByRef arg1 As Short)

	
	'--------------------
	' DLL entry function declarations needed for GPIB global variables
	'--------------------
    Declare Function RegisterGpibGlobalsForThread Lib "Gpib-32.dll" (<MarshalAs(UnmanagedType.LPArray)> ByVal Longibsta() As Integer, <MarshalAs(UnmanagedType.LPArray)> ByVal Longiberr() As Integer, <MarshalAs(UnmanagedType.LPArray)> ByVal Longibcnt() As Integer, <MarshalAs(UnmanagedType.LPArray)> ByVal ibcntl() As Integer) As Integer
	...
	Sub copy_ibvars()
        ibsta = ConvertLongToInt(Longibsta(0))
        iberr = CShort(Longiberr(0))
        ibcnt = ConvertLongToInt(ibcntl(0))
	End Sub
	...
	Sub ibrpp(ByVal ud As Short, ByRef ppr As Short)
        Static tmp_str As New String("", 2)
