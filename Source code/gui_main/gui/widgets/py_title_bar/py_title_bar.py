...
class PyTitleBar(QWidget):
    ...
    def __init__(
        ...
        self.top_logo.setMinimumHeight(logo_hight)
        self.top_logo.setMaximumHeight(logo_hight)
    ...
    def maximize_restore(self, e = None):
        ...
        def change_ui():
            if _is_maximized:
                ...
                self.maximize_restore_button._tooltip.setText("   戻す")
            else:
                ...
                self.maximize_restore_button._tooltip.setText("最大化")
        # CHECK EVENT
    ...
    def setup_ui(self):
        ...
        self.title_label.setStyleSheet(f'font: {self._title_size}pt "{self._font_family}";font-weight: bold')
