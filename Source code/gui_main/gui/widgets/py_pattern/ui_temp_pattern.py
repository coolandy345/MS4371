...
"border:none;")
        ...
        self.gridLayout_4.setContentsMargins(9, 2, 9, 2)
...
"border-radius: 4px;")
        ...
        self.gridLayout_4.addWidget(self.PID_muffle_comboBox, 8, 1, 1, 2)
...
"border-radius: 4px;")
        ...
        self.gridLayout_4.addWidget(self.PID_heater_comboBox, 9, 1, 1, 2)
...
"font: 12px \"\u6e38\u30b4\u30b7\u30c3\u30af\";")
        ...
        self.gridLayout_4.addWidget(self.N2_lineEdit, 6, 1, 1, 2)
...
"background-color: rgb(30, 34, 41);")
        ...
        self.gridLayout_4.addWidget(self.time_frame, 2, 1, 1, 2)

        self.Step_label = QLabel(self.page2)
        self.Step_label.setObjectName(u"Step_label")
        self.Step_label.setMinimumSize(QSize(0, 30))
...
"border:none;")
        ...
        self.gridLayout_4.addWidget(self.PID_heater_label, 9, 0, 1, 1)
...
"font: 12px \"\u6e38\u30b4\u30b7\u30c3\u30af\";")
        ...
        self.gridLayout_4.addWidget(self.KeepTime_lineEdit, 12, 1, 1, 2)
...
"border:none;")
        ...
        self.gridLayout_4.addWidget(self.KeepTime_label, 12, 0, 1, 1)
...
"border:none;")
        ...
        self.gridLayout_4.addWidget(self.PID_muffle_label, 8, 0, 1, 1)
        ...
        self.TestPattern_label.setMaximumSize(QSize(80, 20))
        self.TestPattern_label.setStyleSheet(u"font:13px \"\u6e38\u30b4\u30b7\u30c3\u30af\";\n"
"color: rgb(225, 230, 241);\n"
"border:none;")

        self.gridLayout_4.addWidget(self.TestPattern_label, 15, 0, 1, 1)
...
"border-radius: 4px;")
        ...
        self.gridLayout_4.addWidget(self.TestPattern_comboBox, 17, 0, 1, 3)
