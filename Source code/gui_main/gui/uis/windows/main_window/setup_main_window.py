...
class SetupMainWindow:
    ...
    def setup_gui(self):
        ...
        self.main_namespace.main_utility_manager= Main_utility_manager(self.main_namespace,queuePool=self.queuePool,eventPool=self.eventPool,PoolSemaphore=self.PoolSemaphore)
        self.main_namespace.testfile_manager=Testfile_manager(self.main_namespace,queuePool=self.queuePool,PoolSemaphore=self.PoolSemaphore)
