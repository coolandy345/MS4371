...
################################################################################
## Form generated from reading UI file 'main_pagesucdJlh.ui'
##
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 948, 671))
...
"}")
        ...
        self.lineEdit_year.setMinimumSize(QSize(60, 0))
        ...
        self.QC_Test_RadioButton.setMinimumSize(QSize(0, 32))
...
"background-color: rgb(36, 40, 49);")
        ...
        self.lineEdit_costomer.setMinimumSize(QSize(200, 0))
        ...
        self.lineEdit_costomerName.setMinimumSize(QSize(200, 0))
...
"}")
        ...
        self.lineEdit_testMeterialName.setMinimumSize(QSize(200, 0))
        ...
        self.lineEdit_testMeterial.setMinimumSize(QSize(200, 0))
        ...
        self.lineEdit_MeterialMainDie.setMinimumSize(QSize(0, 0))
...
"}")
        ...
        self.lineEdit_PID_0_D.setMinimumSize(QSize(0, 0))
        self.lineEdit_PID_0_D.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.lineEdit_PID_0_I.setMinimumSize(QSize(0, 0))
        self.lineEdit_PID_0_I.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.lineEdit_PID_0_P.setMinimumSize(QSize(0, 0))
        self.lineEdit_PID_0_P.setMaximumSize(QSize(16777215, 16777215))
...
"}")
        ...
        self.lineEdit_PID_1_D.setMinimumSize(QSize(0, 0))
        ...
        self.lineEdit_PID_1_I.setMinimumSize(QSize(0, 0))
        ...
        self.lineEdit_PID_1_P.setMinimumSize(QSize(0, 0))
...
"}")
        ...
        self.lineEdit_PID_2_D.setMinimumSize(QSize(0, 0))
        ...
        self.lineEdit_PID_2_I.setMinimumSize(QSize(0, 0))
        ...
        self.lineEdit_PID_2_P.setMinimumSize(QSize(0, 0))
...
"}")
        ...
        self.lineEdit_PID_3_D.setMinimumSize(QSize(0, 0))
        ...
        self.lineEdit_PID_3_I.setMinimumSize(QSize(0, 0))
        ...
        self.lineEdit_PID_3_P.setMinimumSize(QSize(0, 0))
...
"}")
        ...
        self.lineEdit_PID_4_D.setMinimumSize(QSize(0, 0))
        ...
        self.lineEdit_PID_4_I.setMinimumSize(QSize(0, 0))
        ...
        self.lineEdit_PID_4_P.setMinimumSize(QSize(0, 0))
...
"")
        ...
        self.gasFreeflow_pushButton.setMinimumSize(QSize(0, 0))
        self.gasFreeflow_pushButton.setMaximumSize(QSize(16777215, 16777215))
...
"border:None")
        ...
        self.voltageOutput_pushButton.setMinimumSize(QSize(0, 0))
        self.voltageOutput_pushButton.setMaximumSize(QSize(16777215, 16777215))
...
"}")
        ...
        self.gridLayout_19.addWidget(self.voltageOutput_pushButton, 1, 0, 1, 1)
...
"}")
        ...
        self.Noisetest_pushButton = QPushButton(self.frame_9)
        self.Noisetest_pushButton.setObjectName(u"Noisetest_pushButton")
        self.Noisetest_pushButton.setMinimumSize(QSize(0, 0))
        self.Noisetest_pushButton.setMaximumSize(QSize(16777215, 16777215))
        self.Noisetest_pushButton.setTabletTracking(False)
...
"")
        ...
        self.gridLayout_19.addWidget(self.Noisetest_pushButton, 0, 0, 1, 1)
...
"	background-color: rgb(220, 37, 95);\n"
"}")
        self.outputStop_pushButton.setCheckable(True)
        ...
        self.manualMeasurement_pushButton.setMinimumSize(QSize(0, 0))
        self.manualMeasurement_pushButton.setMaximumSize(QSize(16777215, 16777215))
...
"}")
        ...
        self.gridLayout_19.addWidget(self.manualMeasurement_pushButton, 2, 0, 1, 1)


        self.gridLayout_20.addWidget(self.frame_9, 1, 0, 1, 1, Qt.AlignHCenter|Qt.AlignBottom)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, -480, 1104, 1620))
...
"}")
        ...
        self.commect_lineEdit.setMinimumSize(QSize(400, 0))
        self.commect_lineEdit.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.patternfile_comboBox.setMaximumSize(QSize(16777215, 16777215))
...
"border:none;")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 1046, 400))
        ...
        self.PatternErrorMessagelabel.setStyleSheet(u"\n"
"color: rgb(221, 0, 0);")
        self.PatternErrorMessagelabel.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_6.addWidget(self.PatternErrorMessagelabel, 2, 8, 1, 1)
...
"}")
        ...
        self.Temp_Totaltime_Label.setStyleSheet(u"font:13px \"\u6e38\u30b4\u30b7\u30c3\u30af\";\n"
"color: rgb(225, 230, 241);\n"
"padding-right:5px;")
        self.Temp_Totaltime_Label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.gridLayout_6.addWidget(self.Temp_Totaltime_Label, 2, 6, 1, 1)
...
"border:none;")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 1046, 200))
...
"}")
        ...
        self.gridLayout_47.addWidget(self.frame_50, 0, 6, 3, 1)
        ...
        self.frame_51.setMinimumSize(QSize(400, 0))
...
"border:none")
        ...
        self.test_sampletime_LineEdit.setMinimumSize(QSize(0, 0))
        self.test_sampletime_LineEdit.setMaximumSize(QSize(16777215, 16777215))
...
"border:none")
        ...
        self.gridLayout_42.addWidget(self.label_64, 0, 12, 1, 1)
        ...
        self.bg_time_LineEdit.setMinimumSize(QSize(0, 0))
        self.bg_time_LineEdit.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.gridLayout_42.addWidget(self.bg_time_LineEdit, 0, 6, 1, 1)
...
"border:none")
        ...
        self.gridLayout_42.addWidget(self.label_61, 0, 5, 1, 1)
        ...
        self.label_66.setStyleSheet(u"font: 13px \"\u6e38\u30b4\u30b7\u30c3\u30af\";\n"
"color: rgb(225, 230, 241);\n"
"padding-right:5px;\n"
"border:none")
        self.label_66.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout_42.addWidget(self.label_66, 1, 5, 1, 1)
        ...
        self.test_time_LineEdit.setMinimumSize(QSize(0, 0))
        self.test_time_LineEdit.setMaximumSize(QSize(16777215, 16777215))
...
"}")
        ...
        self.gridLayout_42.addWidget(self.frame_73, 0, 10, 2, 1)
        ...
        self.bg0_time_LineEdit.setMinimumSize(QSize(0, 0))
        self.bg0_time_LineEdit.setMaximumSize(QSize(16777215, 16777215))
...
"border:none")
        ...
        self.bg_sampletime_LineEdit.setMinimumSize(QSize(0, 0))
        self.bg_sampletime_LineEdit.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.gridLayout_42.addWidget(self.bg_sampletime_LineEdit, 1, 6, 1, 1)

        self.SUM_filter_LineEdit = QLineEdit(self.frame_51)
        self.SUM_filter_LineEdit.setObjectName(u"SUM_filter_LineEdit")
        sizePolicy.setHeightForWidth(self.SUM_filter_LineEdit.sizePolicy().hasHeightForWidth())
        self.SUM_filter_LineEdit.setSizePolicy(sizePolicy)
        self.SUM_filter_LineEdit.setMinimumSize(QSize(0, 0))
        self.SUM_filter_LineEdit.setMaximumSize(QSize(16777215, 16777215))
        self.SUM_filter_LineEdit.setStyleSheet(u"")
        self.SUM_filter_LineEdit.setAlignment(Qt.AlignCenter)
        self.SUM_filter_LineEdit.setReadOnly(False)

        self.gridLayout_42.addWidget(self.SUM_filter_LineEdit, 0, 13, 1, 1)
...
"padding:5px")
    ...
    def retranslateUi(self, MainPages):
        ...
        self.label_64.setText(QCoreApplication.translate("MainPages", u"SUM\u30d5\u30a3\u30eb\u30bf\u30fc", None))
        ...
        self.SUM_filter_LineEdit.setText(QCoreApplication.translate("MainPages", u"0", None))
