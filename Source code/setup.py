...
includefiles = ['error.ico', 'icon.ico', 'warning.ico', 'libusb-1.0.dll', 'gui_main','Database and Profile','取説資料','データベース初期化工具.bat',"make_database.py","make_database2.py","make_database3.py","README.md"]
